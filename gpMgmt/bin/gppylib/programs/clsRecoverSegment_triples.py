...
class RecoveryTriplets(abc.ABC):
    ...
    def _convert_requests_to_triplets(self, requests: List[RecoveryTripletRequest]) -> List[RecoveryTriplet]:
        ...
        for req in requests:
            ...
            #  "<failed_address>|<failed_port>|<failed_data_dir> <failed_address>|<failed_port>|<failed_data_dir>"
            #  does full recovery "<failed_address>|<failed_port>|<failed_data_dir>" does incremental recovery
